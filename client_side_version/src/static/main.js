...
class GameScene extends Phaser.Scene {
    ...
    update(time, delta) {
        ...
        this.scoreText2.setText('score: ' + score2);  
...
function destroyPlayerShip(context, ship, engineArr, player) {
    ...
    shipExplTween.on('complete', () => {
        let ship_explosion = context.physics.add.sprite(ship.x, ship.y, 'expl2');
...
function multiExplosion(context, ship){
    ...
    let explosion = context.physics.add.sprite(ship.x, ship.y, 'expl1crop');
